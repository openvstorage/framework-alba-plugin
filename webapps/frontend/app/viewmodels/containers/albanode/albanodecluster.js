...
define([
    ...
    var albaNodeClusterMapping = {
        'alba_nodes': {
            ...
            create: function(data) {  // This object has not yet been converted to work with ko.mapping thus manually overriden the create

            }
        }
    };

    var albaNodeClusterModel = function(albaBackend, parentVM, data){
        // Variables
        self.shared      = shared;
        self.albaBackend = albaBackend;
        self.parentVM    = parentVM;  // Parent ViewModel, so backend-alba-detail page in this case

        // Default data - replaces fillData
        var vmData = $.extend({
            alba_nodes: []
        }, data);
    ...
    return function(nodeID, albaBackend, parentVM, data) {
        var self = this;
