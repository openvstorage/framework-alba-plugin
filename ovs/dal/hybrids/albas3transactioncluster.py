...
class S3TransactionCluster(DataObject):
    """
    ...
    * my_service.abm_service.abm_cluster.alba_backend
    """
    __properties = [Property('name', str, unique=True, doc='Name of the S3 Transaction Arakoon cluster'),
                    Property('config_location', str, unique=True, doc='Location of the Arakoon configuration')]
    __relations = []
    __dynamics = []
